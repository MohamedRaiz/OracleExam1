...
class Employee {
    public void printPublic() { System.out.println("An Employee can make a public statement"); }

    protected void printProtected() { System.out.println("An Employee can make a protected statement"); }

    void printPackage() { System.out.println("An Employee can make a package statement"); }

    private void printPrivate() {
        System.out.println("An Employee can make a private statement, but only the employee can make it accessible through" +
                " other means..");
    }
    // blog method is pass through to the private printPrivate method
    protected void blog() { printPrivate(); }
}
...
class Boss extends Employee {
    ...
    public void printPrivate() { System.out.println("A Boss's private statements can be made public now"); }

    // making a package-private method on parent protected on child
    protected void printPackage() { System.out.println("A Boss's packaged speech can be shared with his children as well now."); }

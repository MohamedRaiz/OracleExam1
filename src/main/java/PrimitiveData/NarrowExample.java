...
public class NarrowExample {
    public static void main(String[] args) {
        ...
        //We will set each variable to the maximum value in its range.
        byte b = 127;
        char c = 65535;
        short s = 32767;
...
//        long l2 = 0.0;
        ...
        //Above is narrowing examples for literals, now below is narrowing examples of other variables.
        int myIntVariable = 1;
//
